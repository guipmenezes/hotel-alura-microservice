...
public class ReservasController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Reservas> findReservasById(@PathVariable("id") @NotNull @Positive Integer reservasId) {
        return reservasService.findReservasById(reservasId);
    }

    @PostMapping
    public ResponseEntity<Reservas> registerReserva(@RequestBody @Valid ReservasRegistrationRequest request) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity updateReserva(@PathVariable("id") @NotNull @Positive Integer reservaId,
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteReserva(@PathVariable("id") @NotNull @Positive Integer reservaId) {
